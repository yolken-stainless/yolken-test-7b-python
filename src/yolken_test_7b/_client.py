...
from ._exceptions import APIStatusError, YolkenTest7bError
...
class YolkenTest7b(SyncAPIClient):
    # client options
    api_key: str
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new synchronous YolkenTest7b client instance.
        ...
        if base_url is None:
            base_url = os.environ.get("YOLKEN_TEST_7B_BASE_URL")
        if base_url is None:
    ...
    @cached_property
    def with_raw_response(self) -> YolkenTest7bWithRawResponse:
        return YolkenTest7bWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> YolkenTest7bWithStreamedResponse:
        return YolkenTest7bWithStreamedResponse(self)
...
class AsyncYolkenTest7b(AsyncAPIClient):
    # client options
    api_key: str
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new async AsyncYolkenTest7b client instance.
    ...
    @cached_property
    def with_raw_response(self) -> AsyncYolkenTest7bWithRawResponse:
        return AsyncYolkenTest7bWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> AsyncYolkenTest7bWithStreamedResponse:
        return AsyncYolkenTest7bWithStreamedResponse(self)
...
class YolkenTest7bWithRawResponse:
    _client: YolkenTest7b

    def __init__(self, client: YolkenTest7b) -> None:
        self._client = client
...
class AsyncYolkenTest7bWithRawResponse:
    _client: AsyncYolkenTest7b

    def __init__(self, client: AsyncYolkenTest7b) -> None:
        self._client = client
...
class YolkenTest7bWithStreamedResponse:
    _client: YolkenTest7b
...
class AsyncYolkenTest7bWithStreamedResponse:
    _client: AsyncYolkenTest7b
